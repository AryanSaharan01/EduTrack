...
async function sendOTPEmail(to, otp) {
  try {
    ...
    sendSmtpEmail.subject = 'Your Verification Code for EduTrack Pro LMS';
    sendSmtpEmail.sender = { name: 'EduTrack Pro LMS - Security Team', email: 'no-reply@edutrackprolms.com' };
    sendSmtpEmail.to = [{ email: to }];
    sendSmtpEmail.textContent = `Your verification code is ${otp}. This code will expire in 2 minutes. If you didn't request this code, please ignore this email.`;
